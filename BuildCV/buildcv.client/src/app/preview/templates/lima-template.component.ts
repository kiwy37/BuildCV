    ...
    return `
      <div class="cv-lima-container" style="${this.applyContainerStyles()}">
        <style>
          ...
          .cv-page { width: 210mm; min-height: 297mm; box-sizing: border-box; }
          ...
          .exp-left { color: ${c.textColor}; opacity: 0.75; font-size: ${c.fontSize - 1}px; }
          .exp-right h3 { margin: 0; font-size: ${c.fontSize * 1.05}px; color: ${c.textColor}; font-weight:700; }
          ...
          <aside class="lima-sidebar">
            <div class="lima-profile">
              <div class="lima-avatar">
                ${pi.photoUrl ? `<img src="${pi.photoUrl}" alt="avatar">` : `<div style="width:100%;height:100%;background:linear-gradient(135deg,#2c3e50,#3b5566);"></div>`}
              </div>
              <div class="lima-name">${(pi.fullName || 'Your Name').toUpperCase()}</div>
            ...
            ${pi.email || pi.phone || pi.location || (pi.linkedIn || pi.website) ? `
              <div class="sidebar-section">
                ...
                <div class="contact-row">
                  ${pi.phone ? `<div class="contact-item"><span class="contact-icon">📞</span><span class="sidebar-text">${pi.phone}</span></div>` : ''}
                  ${pi.email ? `<div class="contact-item"><span class="contact-icon">✉️</span><span class="sidebar-text">${pi.email}</span></div>` : ''}
                  ${pi.location ? `<div class="contact-item"><span class="contact-icon">📍</span><span class="sidebar-text">${pi.location}</span></div>` : ''}
                  ${pi.linkedIn ? `<div class="contact-item"><span class="contact-icon">🔗</span><a class="sidebar-text" href="${pi.linkedIn}" target="_blank" style="color:inherit;text-decoration:none">LinkedIn</a></div>` : ''}
                  ${pi.website ? `<div class="contact-item"><span class="contact-icon">🔗</span><a class="sidebar-text" href="${pi.website}" target="_blank" style="color:inherit;text-decoration:none">Website</a></div>` : ''}
                </div>
              </div>
            ` : ''}
